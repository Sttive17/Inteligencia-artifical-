...
if __name__ == "__main__":
    ...
    archivo_entrada = os.path.join(directorio_actual, "cultivos.csv")
    archivo_salida = os.path.join(directorio_actual, "informe_cultivos.md")
    
    cultivos = leer_cultivos(archivo_entrada)
    estadisticas = calcular_estadisticas(cultivos)
    generar_informe(estadisticas, archivo_salida)
